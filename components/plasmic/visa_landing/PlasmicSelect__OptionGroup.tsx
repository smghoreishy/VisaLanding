...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: iS2GUlSy3S5A/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 6H_b-lY_Llg6/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__dt3Pf)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__ccEin)}
              />
            </React.Fragment>
          ),
          value: args.children
